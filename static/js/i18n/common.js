(function(){
    ...
    window.StudioI18n.register({
        ...
        "common.project": { zh: "浅色主页", en: "Qianse Home" },
        ...
        "nav.basicTools": { zh: "基础功能", en: "Basic Tools" },
        ...
        "nav.imageGeneration": { zh: "图片生成", en: "Image Generation" },
        "nav.detailPage": { zh: "一键详情页", en: "Detail Page" },
        "nav.gpt": { zh: "GPT 对话", en: "GPT Chat" },
        "nav.canvas": { zh: "无限画布", en: "Infinite Canvas" },
        "nav.assetManager": { zh: "素材库", en: "Assets" },
        "nav.backupRestore": { zh: "备份与恢复", en: "Backup & Restore" },
        "backup.title": { zh: "备份与恢复", en: "Backup & Restore" },
        "backup.export": { zh: "导出备份", en: "Export backup" },
        "backup.import": { zh: "导入备份", en: "Import backup" },
        "backup.exportHint": { zh: "选择画布、历史和配置", en: "Choose canvases, history, and settings" },
        "backup.importHint": { zh: "检查备份内容后恢复", en: "Review the backup before restoring" },
