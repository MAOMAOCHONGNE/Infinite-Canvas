(function(){
    ...
    window.StudioI18n.register({
        ...
        "smart.promptTemplateLibrary": { zh: "提示词", en: "Prompts" },
        "smart.promptTemplateTarget": { zh: "写入到：{target}", en: "Write to: {target}" },
        "smart.promptTemplateTargetNode": { zh: "提示词节点", en: "Prompt node" },
        "smart.promptTemplateTargetComposer": { zh: "输入框", en: "Composer" },
        "smart.promptTemplateTargetMissing": { zh: "请先只选择一个提示词节点", en: "Select exactly one prompt node first" },
        "smart.promptTemplateBrowse": { zh: "浏览模式", en: "Browse mode" },
        "smart.promptTemplateWriteTargetMissing": { zh: "浏览模式不能写入，请先选择一个提示词节点", en: "Browse mode cannot write. Select a prompt node first." },
        ...
        "smart.tplCopyPrompt": { zh: "复制提示词", en: "Copy prompt" },
        "smart.tplWriteNode": { zh: "写入节点", en: "Write to node" },
        "smart.tplCopyNegative": { zh: "复制负向提示词", en: "Copy negative prompt" },
        "smart.tplCopiedPositive": { zh: "提示词已复制", en: "Prompt copied" },
        "smart.tplCopiedNegative": { zh: "负向提示词已复制", en: "Negative prompt copied" },
        ...
        "smart.promptLlmNoResultForInput": { zh: "当前输入尚未运行 LLM", en: "LLM has not run for the current input." },
        "smart.promptLlmFailed": { zh: "LLM 运行失败", en: "LLM run failed" },
        "smart.loopPromptHintFound": { zh: "识别到 {n} 条提示词，按序号逐轮输出", en: "Found {n} prompt(s); one is used per round" },
        "smart.loopPromptHintVariable": { zh: "可插入 [序号] 变量", en: "Insert the [Index] variable" },
        "smart.loopTotalRounds": { zh: "总轮数", en: "Total rounds" },
        "smart.loopSummaryImageSingle": { zh: "图片{n}", en: "Image {n}" },
        "smart.loopSummaryImageRange": { zh: "图片{start}–{end}", en: "Images {start}–{end}" },
        "smart.loopSummaryNoImages": { zh: "无图片", en: "No images" },
        "smart.loopSummaryCurrentImages": { zh: "本轮：{range}", en: "Current: {range}" },
        "smart.loopSummaryNextImages": { zh: "下一轮：{range}", en: "Next: {range}" },
        "smart.loopSummaryNoNextImages": { zh: "下一轮：无", en: "Next: none" },
        "smart.loopSummaryImageDisabled": { zh: "图片未启用", en: "Images disabled" },
        "smart.loopSummaryPrompt": { zh: "识别到 {n} 条提示词，本轮：{text}", en: "Found {n} prompt(s), current: {text}" },
        "smart.loopSummaryPromptEmpty": { zh: "识别到 {n} 条提示词，本轮：无", en: "Found {n} prompt(s), current: none" },
        "smart.loopSummaryPromptDisabled": { zh: "提示词未启用", en: "Prompts disabled" },
        ...
        "smart.toastNoRedo": { zh: "没有可恢复的操作", en: "Nothing to redo" },
        "smart.toastRedone": { zh: "已恢复", en: "Redone" },
        ...
        "smart.shortcutPrompts": { zh: "为选中的节点打开提示词库", en: "Open the prompt library for the selected node" },
